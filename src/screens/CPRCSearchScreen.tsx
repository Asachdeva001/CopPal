...
const mockData: CPRCSection[] = [
  {
    id: '1',
    title: 'Section 154',
    description: 'Information in cognizable cases - How to record FIR',
  ...
  },
  {
    id: '4',
    title: 'Section 167',
    description: 'Procedure when investigation cannot be completed in twenty-four hours',
    category: 'Investigation',
  },
  {
    id: '5',
    title: 'Section 173',
    description: 'Report of police officer on completion of investigation',
    category: 'Investigation',
  },
  {
    id: '6',
    title: 'Section 190',
    description: 'Cognizance of offences by Magistrates',
    category: 'Court Procedure',
  },
];

const CPRCSearchScreen: React.FC = () => {
  ...
  const renderItem = ({ item }: { item: CPRCSection }) => (
    <TouchableOpacity
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.searchContainer, { backgroundColor: colors.card }]}>
        ...
        <TextInput
          ...
          placeholder="Search CPRC sections..."
...
export default CPRCSearchScreen; 